...
public class LailiaojianyanView extends LailiaojianyanEntity implements Serializable {
	...
	* 来料检验类型的值
	*/
	@ColumnInfo(comment="来料检验类型的字典表值",type="varchar(200)")
	private String lailiaojianyanValue;
	/**
	* 质量等级的值
	*/
	...
	*/
	...
	public LailiaojianyanView() {

	}

	public LailiaojianyanView(LailiaojianyanEntity lailiaojianyanEntity) {
		try {
			BeanUtils.copyProperties(this, lailiaojianyanEntity);
	...
	* 获取： 来料检验类型的值
	*/
	public String getLailiaojianyanValue() {
		return lailiaojianyanValue;
	}
	/**
	* 设置： 来料检验类型的值
	*/
	public void setLailiaojianyanValue(String lailiaojianyanValue) {
		this.lailiaojianyanValue = lailiaojianyanValue;
	}
	//当前表的
	/**
	* 获取： 质量等级的值
