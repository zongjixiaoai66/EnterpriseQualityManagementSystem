...
public class ChengpinjianyanView extends ChengpinjianyanEntity implements Serializable {
	...
	* 成品检验类型的值
	*/
	@ColumnInfo(comment="成品检验类型的字典表值",type="varchar(200)")
	private String chengpinjianyanValue;
	/**
	* 质量等级的值
	*/
	...
	* 获取： 成品检验类型的值
	*/
	public String getChengpinjianyanValue() {
		return chengpinjianyanValue;
	}
	/**
	* 设置： 成品检验类型的值
	*/
	public void setChengpinjianyanValue(String chengpinjianyanValue) {
		this.chengpinjianyanValue = chengpinjianyanValue;
	}
	//当前表的
	/**
	* 获取： 质量等级的值
