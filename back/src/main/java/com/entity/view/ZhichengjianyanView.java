...
public class ZhichengjianyanView extends ZhichengjianyanEntity implements Serializable {
	...
	* 制成检验类型的值
	*/
	@ColumnInfo(comment="制成检验类型的字典表值",type="varchar(200)")
	private String zhichengjianyanValue;
	/**
	* 质量等级的值
	*/
	...
	*/
	...
	public ZhichengjianyanView() {

	}

	public ZhichengjianyanView(ZhichengjianyanEntity zhichengjianyanEntity) {
		try {
			BeanUtils.copyProperties(this, zhichengjianyanEntity);
	...
	* 获取： 制成检验类型的值
	*/
	public String getZhichengjianyanValue() {
		return zhichengjianyanValue;
	}
	/**
	* 设置： 制成检验类型的值
	*/
	public void setZhichengjianyanValue(String zhichengjianyanValue) {
		this.zhichengjianyanValue = zhichengjianyanValue;
	}
	//当前表的
	/**
	* 获取： 质量等级的值
