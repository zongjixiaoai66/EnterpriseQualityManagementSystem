...
public class KongzhituchushihuaView extends KongzhituchushihuaEntity implements Serializable {
	...
	* 控制图初始化类型的值
	*/
	@ColumnInfo(comment="控制图初始化类型的字典表值",type="varchar(200)")
	private String kongzhituchushihuaValue;
	...
	public KongzhituchushihuaView() {

	}

	public KongzhituchushihuaView(KongzhituchushihuaEntity kongzhituchushihuaEntity) {
		try {
			BeanUtils.copyProperties(this, kongzhituchushihuaEntity);
	...
	* 获取： 控制图初始化类型的值
	*/
	public String getKongzhituchushihuaValue() {
		return kongzhituchushihuaValue;
	}
	/**
	* 设置： 控制图初始化类型的值
	*/
	public void setKongzhituchushihuaValue(String kongzhituchushihuaValue) {
		this.kongzhituchushihuaValue = kongzhituchushihuaValue;
	}
	...
	public String toString() {
		return "KongzhituchushihuaView{" +
			", kongzhituchushihuaValue=" + kongzhituchushihuaValue +
