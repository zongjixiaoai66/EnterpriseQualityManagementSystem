...
*/
@TableName("zhifangtu")
public class ZhifangtuView extends ZhifangtuEntity implements Serializable {
	...
	* 直方图输出类型的值
	*/
	@ColumnInfo(comment="直方图输出类型的字典表值",type="varchar(200)")
	private String zhifangtuValue;
	...
	public ZhifangtuView() {

	}

	public ZhifangtuView(ZhifangtuEntity zhifangtuEntity) {
		try {
			BeanUtils.copyProperties(this, zhifangtuEntity);
	...
	* 获取： 直方图输出类型的值
	*/
	public String getZhifangtuValue() {
		return zhifangtuValue;
	}
	/**
	* 设置： 直方图输出类型的值
	*/
	public void setZhifangtuValue(String zhifangtuValue) {
		this.zhifangtuValue = zhifangtuValue;
	}
	...
	public String toString() {
		return "ZhifangtuView{" +
			", zhifangtuValue=" + zhifangtuValue +
