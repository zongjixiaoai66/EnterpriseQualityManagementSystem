...
public class LailiaojianyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public LailiaojianyanEntity() {

	}

	public LailiaojianyanEntity(T t) {
		try {
     ...
     * 来料检验类型
     */
    @ColumnInfo(comment="来料检验类型",type="int(11)")
    ...
    public String toString() {
        return "Lailiaojianyan{" +
            ", id=" + id +
            ", gongzuorenyuanId=" + gongzuorenyuanId +
            ", lailiaojianyanUuidNumber=" + lailiaojianyanUuidNumber +
            ", lailiaojianyanName=" + lailiaojianyanName +
            ...
            ", lailiaojianyanFile=" + lailiaojianyanFile +
            ", lailiaojianyanTime=" + DateUtil.convertString(lailiaojianyanTime,"yyyy-MM-dd") +
            ...
            ", lailiaojianyanContent=" + lailiaojianyanContent +
            ", lailiaojianyanBeizhuContent=" + lailiaojianyanBeizhuContent +
