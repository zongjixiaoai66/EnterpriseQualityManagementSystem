...
public class ChuhuojianyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ChuhuojianyanEntity() {

	}

	public ChuhuojianyanEntity(T t) {
		try {
     ...
     * 出货检验类型
     */
    @ColumnInfo(comment="出货检验类型",type="int(11)")
    ...
    public String toString() {
        return "Chuhuojianyan{" +
            ", id=" + id +
            ", gongzuorenyuanId=" + gongzuorenyuanId +
            ", chuhuojianyanUuidNumber=" + chuhuojianyanUuidNumber +
            ", chuhuojianyanName=" + chuhuojianyanName +
            ...
            ", chuhuojianyanFile=" + chuhuojianyanFile +
            ", chuhuojianyanTime=" + DateUtil.convertString(chuhuojianyanTime,"yyyy-MM-dd") +
            ...
            ", chuhuojianyanContent=" + chuhuojianyanContent +
            ", chuhuojianyanBeizhuContent=" + chuhuojianyanBeizhuContent +
