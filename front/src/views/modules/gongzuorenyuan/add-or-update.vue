        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工作人员编号" prop="gongzuorenyuanUuidNumber">
                       <el-input v-model="ruleForm.gongzuorenyuanUuidNumber"
                                 placeholder="工作人员编号" clearable  :readonly="ro.gongzuorenyuanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="检验工种" prop="jianyangongzhongTypes">
                        <el-select v-model="ruleForm.jianyangongzhongTypes" :disabled="ro.jianyangongzhongTypes" placeholder="请选择检验工种">
                            <el-option
        ...
        data() {
            return {
                ...
                ruleForm: {
                    username: '',
                    password: '',
                    gongzuorenyuanUuidNumber: new Date().getTime(),
                    gongzuorenyuanName: '',
                    gongzuorenyuanPhone: '',
                    gongzuorenyuanIdNumber: '',
                    gongzuorenyuanPhoto: '',
                    sexTypes: '',
                    jianyangongzhongTypes: '',
                    gongzuorenyuanEmail: '',
                    jinyongTypes: '',
                },
                sexTypesOptions : [],
                ...
                rules: {
                   ...
                   gongzuorenyuanUuidNumber: [
                              { required: true, message: '工作人员编号不能为空', trigger: 'blur' },
                          ],
                   gongzuorenyuanName: [
                   ...
                   jianyangongzhongTypes: [
                              { required: true, message: '检验工种不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
