    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="gongzuorenyuanId" name="gongzuorenyuanId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="检验编号" prop="lailiaojianyanUuidNumber">
                       <el-input v-model="ruleForm.lailiaojianyanUuidNumber"
                                 placeholder="检验编号" clearable  :readonly="ro.lailiaojianyanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="检验编号" prop="lailiaojianyanUuidNumber">
                           <el-input v-model="ruleForm.lailiaojianyanUuidNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="检验标题" prop="lailiaojianyanName">
                       <el-input v-model="ruleForm.lailiaojianyanName"
                                 placeholder="检验标题" clearable  :readonly="ro.lailiaojianyanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="检验标题" prop="lailiaojianyanName">
                           <el-input v-model="ruleForm.lailiaojianyanName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="来料检验类型" prop="lailiaojianyanTypes">
                        <el-select v-model="ruleForm.lailiaojianyanTypes" :disabled="ro.lailiaojianyanTypes" placeholder="请选择来料检验类型">
                            <el-option
                                v-for="(item,index) in lailiaojianyanTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="来料检验类型" prop="lailiaojianyanValue">
                        <el-input v-model="ruleForm.lailiaojianyanValue"
                            placeholder="来料检验类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.lailiaojianyanFile" label="检验文件" prop="lailiaojianyanFile">
                        <file-upload
                                tip="点击上传检验文件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.lailiaojianyanFile?$base.url+ruleForm.lailiaojianyanFile:''"
                                @change="lailiaojianyanFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.lailiaojianyanFile" label="检验文件" prop="lailiaojianyanFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.lailiaojianyanFile"  >检验文件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.lailiaojianyanTime"  class="input" label="检验时间" prop="lailiaojianyanTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.lailiaojianyanTime"
                                type="datetime"
                                placeholder="检验时间"
                                :disabled="ro.lailiaojianyanTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.lailiaojianyanTime" label="检验时间" prop="lailiaojianyanTime">
                            <span v-html="ruleForm.lailiaojianyanTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.lailiaojianyanContent"  label="检验结果" prop="lailiaojianyanContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.lailiaojianyanContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.lailiaojianyanContent" label="检验结果" prop="lailiaojianyanContent">
                            <span v-html="ruleForm.lailiaojianyanContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.lailiaojianyanBeizhuContent"  label="备注" prop="lailiaojianyanBeizhuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.lailiaojianyanBeizhuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.lailiaojianyanBeizhuContent" label="备注" prop="lailiaojianyanBeizhuContent">
                            <span v-html="ruleForm.lailiaojianyanBeizhuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    lailiaojianyanUuidNumber: true,
                    lailiaojianyanName: false,
                    jianyanzhongxinTypes: false,
                    jianyanyiqiTypes: false,
                    jianyanxiangmuTypes: false,
                    lailiaojianyanTypes: false,
                    lailiaojianyanFile: false,
                    lailiaojianyanTime: false,
                    zhiliangdengjiTypes: false,
                    quexiandengjiTypes: false,
                    quexianyuanyinTypes: false,
                    jieguoTypes: false,
                    lailiaojianyanContent: false,
                    lailiaojianyanBeizhuContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    gongzuorenyuanId: '',
                    lailiaojianyanUuidNumber: new Date().getTime(),
                    lailiaojianyanName: '',
                ...
                rules: {
                   ...
                   lailiaojianyanTypes: [
                              { required: true, message: '来料检验类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=lailiaojianyan_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.lailiaojianyanTypesOptions = data.data.list;
                    }
                });
                this.$http({
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `lailiaojianyan/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.gongzuorenyuanChange(data.data.gongzuorenyuanId)
                        _this.ruleForm.lailiaojianyanContent = _this.ruleForm.lailiaojianyanContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.lailiaojianyanBeizhuContent = _this.ruleForm.lailiaojianyanBeizhuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.lailiaojianyanContent = this.ruleForm.lailiaojianyanContent.replaceAll(this.$base.url,"");
                        this.ruleForm.lailiaojianyanBeizhuContent = this.ruleForm.lailiaojianyanBeizhuContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`lailiaojianyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.lailiaojianyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            lailiaojianyanFileUploadChange(fileUrls){
                this.ruleForm.lailiaojianyanFile = fileUrls;
                this.addEditUploadStyleChange()
            },
