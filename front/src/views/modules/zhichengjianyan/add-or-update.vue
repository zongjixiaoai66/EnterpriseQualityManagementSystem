    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="gongzuorenyuanId" name="gongzuorenyuanId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="检验编号" prop="zhichengjianyanUuidNumber">
                       <el-input v-model="ruleForm.zhichengjianyanUuidNumber"
                                 placeholder="检验编号" clearable  :readonly="ro.zhichengjianyanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="检验编号" prop="zhichengjianyanUuidNumber">
                           <el-input v-model="ruleForm.zhichengjianyanUuidNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="检验标题" prop="zhichengjianyanName">
                       <el-input v-model="ruleForm.zhichengjianyanName"
                                 placeholder="检验标题" clearable  :readonly="ro.zhichengjianyanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="检验标题" prop="zhichengjianyanName">
                           <el-input v-model="ruleForm.zhichengjianyanName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="制成检验类型" prop="zhichengjianyanTypes">
                        <el-select v-model="ruleForm.zhichengjianyanTypes" :disabled="ro.zhichengjianyanTypes" placeholder="请选择制成检验类型">
                            <el-option
                                v-for="(item,index) in zhichengjianyanTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="制成检验类型" prop="zhichengjianyanValue">
                        <el-input v-model="ruleForm.zhichengjianyanValue"
                            placeholder="制成检验类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.zhichengjianyanFile" label="检验文件" prop="zhichengjianyanFile">
                        <file-upload
                                tip="点击上传检验文件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.zhichengjianyanFile?$base.url+ruleForm.zhichengjianyanFile:''"
                                @change="zhichengjianyanFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.zhichengjianyanFile" label="检验文件" prop="zhichengjianyanFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.zhichengjianyanFile"  >检验文件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.zhichengjianyanTime"  class="input" label="检验时间" prop="zhichengjianyanTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.zhichengjianyanTime"
                                type="datetime"
                                placeholder="检验时间"
                                :disabled="ro.zhichengjianyanTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zhichengjianyanTime" label="检验时间" prop="zhichengjianyanTime">
                            <span v-html="ruleForm.zhichengjianyanTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.zhichengjianyanContent"  label="检验结果" prop="zhichengjianyanContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.zhichengjianyanContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zhichengjianyanContent" label="检验结果" prop="zhichengjianyanContent">
                            <span v-html="ruleForm.zhichengjianyanContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.zhichengjianyanBeizhuContent"  label="备注" prop="zhichengjianyanBeizhuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.zhichengjianyanBeizhuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zhichengjianyanBeizhuContent" label="备注" prop="zhichengjianyanBeizhuContent">
                            <span v-html="ruleForm.zhichengjianyanBeizhuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    zhichengjianyanUuidNumber: true,
                    zhichengjianyanName: false,
                    jianyanzhongxinTypes: false,
                    jianyanyiqiTypes: false,
                    jianyanxiangmuTypes: false,
                    zhichengjianyanTypes: false,
                    zhichengjianyanFile: false,
                    zhichengjianyanTime: false,
                    zhiliangdengjiTypes: false,
                    quexiandengjiTypes: false,
                    quexianyuanyinTypes: false,
                    jieguoTypes: false,
                    zhichengjianyanContent: false,
                    zhichengjianyanBeizhuContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    gongzuorenyuanId: '',
                    zhichengjianyanUuidNumber: new Date().getTime(),
                    zhichengjianyanName: '',
                    jianyanzhongxinTypes: '',
                    jianyanyiqiTypes: '',
                    jianyanxiangmuTypes: '',
                    zhichengjianyanTypes: '',
                    zhichengjianyanFile: '',
                    zhichengjianyanTime: '',
                    zhiliangdengjiTypes: '',
                    quexiandengjiTypes: '',
                    quexianyuanyinTypes: '',
                    jieguoTypes: '',
                    zhichengjianyanContent: '',
                    zhichengjianyanBeizhuContent: '',
                    insertTime: '',
                },
                jianyanzhongxinTypesOptions : [],
                jianyanyiqiTypesOptions : [],
                jianyanxiangmuTypesOptions : [],
                zhichengjianyanTypesOptions : [],
                ...
                rules: {
                   ...
                   zhichengjianyanTypes: [
                              { required: true, message: '制成检验类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhichengjianyan_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhichengjianyanTypesOptions = data.data.list;
                    }
                });
                this.$http({
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `zhichengjianyan/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.gongzuorenyuanChange(data.data.gongzuorenyuanId)
                        _this.ruleForm.zhichengjianyanContent = _this.ruleForm.zhichengjianyanContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.zhichengjianyanBeizhuContent = _this.ruleForm.zhichengjianyanBeizhuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.zhichengjianyanContent = this.ruleForm.zhichengjianyanContent.replaceAll(this.$base.url,"");
                        this.ruleForm.zhichengjianyanBeizhuContent = this.ruleForm.zhichengjianyanBeizhuContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`zhichengjianyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zhichengjianyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            zhichengjianyanFileUploadChange(fileUrls){
                this.ruleForm.zhichengjianyanFile = fileUrls;
                this.addEditUploadStyleChange()
            },
