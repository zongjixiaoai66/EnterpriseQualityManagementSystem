    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="gongzuorenyuanId" name="gongzuorenyuanId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="检验编号" prop="chengpinjianyanUuidNumber">
                       <el-input v-model="ruleForm.chengpinjianyanUuidNumber"
                                 placeholder="检验编号" clearable  :readonly="ro.chengpinjianyanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="检验编号" prop="chengpinjianyanUuidNumber">
                           <el-input v-model="ruleForm.chengpinjianyanUuidNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="检验标题" prop="chengpinjianyanName">
                       <el-input v-model="ruleForm.chengpinjianyanName"
                                 placeholder="检验标题" clearable  :readonly="ro.chengpinjianyanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="检验标题" prop="chengpinjianyanName">
                           <el-input v-model="ruleForm.chengpinjianyanName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="成品检验类型" prop="chengpinjianyanTypes">
                        <el-select v-model="ruleForm.chengpinjianyanTypes" :disabled="ro.chengpinjianyanTypes" placeholder="请选择成品检验类型">
                            <el-option
                                v-for="(item,index) in chengpinjianyanTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="成品检验类型" prop="chengpinjianyanValue">
                        <el-input v-model="ruleForm.chengpinjianyanValue"
                            placeholder="成品检验类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.chengpinjianyanFile" label="检验文件" prop="chengpinjianyanFile">
                        <file-upload
                                tip="点击上传检验文件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.chengpinjianyanFile?$base.url+ruleForm.chengpinjianyanFile:''"
                                @change="chengpinjianyanFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chengpinjianyanFile" label="检验文件" prop="chengpinjianyanFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.chengpinjianyanFile"  >检验文件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.chengpinjianyanTime"  class="input" label="检验时间" prop="chengpinjianyanTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.chengpinjianyanTime"
                                type="datetime"
                                placeholder="检验时间"
                                :disabled="ro.chengpinjianyanTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chengpinjianyanTime" label="检验时间" prop="chengpinjianyanTime">
                            <span v-html="ruleForm.chengpinjianyanTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.chengpinjianyanContent"  label="检验结果" prop="chengpinjianyanContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.chengpinjianyanContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chengpinjianyanContent" label="检验结果" prop="chengpinjianyanContent">
                            <span v-html="ruleForm.chengpinjianyanContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.chengpinjianyanBeizhuContent"  label="备注" prop="chengpinjianyanBeizhuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.chengpinjianyanBeizhuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chengpinjianyanBeizhuContent" label="备注" prop="chengpinjianyanBeizhuContent">
                            <span v-html="ruleForm.chengpinjianyanBeizhuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    chengpinjianyanUuidNumber: true,
                    chengpinjianyanName: false,
                    jianyanzhongxinTypes: false,
                    jianyanyiqiTypes: false,
                    jianyanxiangmuTypes: false,
                    chengpinjianyanTypes: false,
                    chengpinjianyanFile: false,
                    chengpinjianyanTime: false,
                    zhiliangdengjiTypes: false,
                    quexiandengjiTypes: false,
                    quexianyuanyinTypes: false,
                    jieguoTypes: false,
                    chengpinjianyanContent: false,
                    chengpinjianyanBeizhuContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    gongzuorenyuanId: '',
                    chengpinjianyanUuidNumber: new Date().getTime(),
                    chengpinjianyanName: '',
                    jianyanzhongxinTypes: '',
                    jianyanyiqiTypes: '',
                    jianyanxiangmuTypes: '',
                    chengpinjianyanTypes: '',
                    chengpinjianyanFile: '',
                    chengpinjianyanTime: '',
                    zhiliangdengjiTypes: '',
                    quexiandengjiTypes: '',
                    quexianyuanyinTypes: '',
                    jieguoTypes: '',
                    chengpinjianyanContent: '',
                    chengpinjianyanBeizhuContent: '',
                    insertTime: '',
                },
                jianyanzhongxinTypesOptions : [],
                jianyanyiqiTypesOptions : [],
                jianyanxiangmuTypesOptions : [],
                chengpinjianyanTypesOptions : [],
                ...
                rules: {
                   ...
                   chengpinjianyanTypes: [
                              { required: true, message: '成品检验类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chengpinjianyan_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chengpinjianyanTypesOptions = data.data.list;
                    }
                });
                this.$http({
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `chengpinjianyan/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.gongzuorenyuanChange(data.data.gongzuorenyuanId)
                        _this.ruleForm.chengpinjianyanContent = _this.ruleForm.chengpinjianyanContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                        _this.ruleForm.chengpinjianyanBeizhuContent = _this.ruleForm.chengpinjianyanBeizhuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.chengpinjianyanContent = this.ruleForm.chengpinjianyanContent.replaceAll(this.$base.url,"");
                        this.ruleForm.chengpinjianyanBeizhuContent = this.ruleForm.chengpinjianyanBeizhuContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`chengpinjianyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chengpinjianyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            chengpinjianyanFileUploadChange(fileUrls){
                this.ruleForm.chengpinjianyanFile = fileUrls;
                this.addEditUploadStyleChange()
            },
